...
def generate():
    try:
        ...
        full_prompt = prompt + ", realistic fabric texture, professional product photography, high quality, sharp focus"

        # fal-ai provider üzerinden img2img — HF token ile ücretsiz kredi
        ...
        if '402' in err or 'credit' in err.lower() or 'billing' in err.lower():
            return jsonify({'error': 'fal-ai krediniz bitti. HF ayarlarından fal-ai provider\'ı aktif edin.'}), 402
